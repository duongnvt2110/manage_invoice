...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::22SznWdZEoJiyhRi',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::1GIh5h3S2XGAQSff',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/_debugbar/(?|c(?|lockwork/([^/]++)(*:42)|ache/([^/]++)(?:/([^/]++))?(*:76))|telescope/([^/]++)(*:102))|/role/(?|edit/([^/]++)(*:133)|update/([^/]++)(*:156)|delete/([^/]++)(*:179))|/p(?|ermission/(?|edit/([^/]++)(*:219)|update/([^/]++)(*:242)|delete/([^/]++)(*:265))|ost/(?|([^/]++)(*:289)|edit/([^/]++)(*:310)|update(*:324)|delete(*:338))|roduct/(?|([^/]++)(*:365)|edit/([^/]++)(*:386)|update(*:400)|delete(*:414)))|/user/(?|edit/([^/]++)(*:446)|update/([^/]++)(*:469)|delete/([^/]++)(*:492))|/customer/(?|([^/]++)(*:522)|edit/([^/]++)(*:543)|update(*:557)|delete(*:571)|search(*:585)))/?$}sDu',
    ),
    3 => 
    array (
      42 => 
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Auth\\HomeController@welcome',
        'controller' => 'App\\Http\\Controllers\\Auth\\HomeController@welcome',
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Auth\\RegisterController@confirm',
        'controller' => 'App\\Http\\Controllers\\Auth\\RegisterController@confirm',
        'namespace' => 'App\\Http\\Controllers\\Auth',
        'prefix' => NULL,
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Auth\\ResetPasswordController@showResetPasswordForm',
        'controller' => 'App\\Http\\Controllers\\Auth\\ResetPasswordController@showResetPasswordForm',
        'namespace' => 'App\\Http\\Controllers\\Auth',
        'prefix' => NULL,
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Auth\\ResetPasswordController@showConfirmationForm',
        'controller' => 'App\\Http\\Controllers\\Auth\\ResetPasswordController@showConfirmationForm',
        'namespace' => 'App\\Http\\Controllers\\Auth',
        'prefix' => NULL,
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Auth\\ResetPasswordController@confirm',
        'controller' => 'App\\Http\\Controllers\\Auth\\ResetPasswordController@confirm',
        'namespace' => 'App\\Http\\Controllers\\Auth',
        'prefix' => NULL,
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\LoanApplicationController@analyze',
        'controller' => 'App\\Http\\Controllers\\LoanApplicationController@analyze',
        'namespace' => 'App\\Http\\Controllers',
        'prefix' => '/loan',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\LoanApplicationController@updateAnalyze',
        'controller' => 'App\\Http\\Controllers\\LoanApplicationController@updateAnalyze',
        'namespace' => 'App\\Http\\Controllers',
        'prefix' => '/loan',
        'where' => 
        array (
        ),
        'as' => 'loan.updateAnalyze',
      ),
      'fallback' => false,
      'defaults' => 
      array (
