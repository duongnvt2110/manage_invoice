...
unset($__errorArgs, $__bag); ?>" name="user_email" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus>
...
unset($__errorArgs, $__bag); ?>" name="user_password" required autocomplete="current-password">
